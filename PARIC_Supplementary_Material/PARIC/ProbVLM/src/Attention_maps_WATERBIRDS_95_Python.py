...
checkpoint_path = '../ProbVLM/ckpt/ProbVLM_waterbirds95_200epochs_17.02_best.pth'
...
# Usage
dataset = 'waterbird_complete95_forest2water2'  # coco or flickr
...
filename = '../ProbVLM/Datasets/CUB/data_loaders_waterbirds_95_17.02.pkl'
...
def process_attention_maps(data_loader, save_folder, aggregation_method, max_files=15):
    ...
    ROOT = "../ProbVLM/Datasets/waterbird_complete95_forest2water2"
