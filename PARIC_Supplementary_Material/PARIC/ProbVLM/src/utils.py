...
import clip
import ds 
from ds import prepare_coco_dataloaders, prepare_flickr_dataloaders, prepare_cub_dataloaders, prepare_flo_dataloaders, prepare_coco_dataloaders_extra, prepare_cub_dataloaders_extra, prepare_foodredmeat_dataloaders, prepare_foodmeat_dataloaders
...
def load_data_loader(dataset, data_dir, dataloader_config):
    if dataset == 'mnist':
        # Handle MNIST manually
        train_loader, val_loader, test_loader = load_mnist_data_loader(
            data_dir=data_dir,
