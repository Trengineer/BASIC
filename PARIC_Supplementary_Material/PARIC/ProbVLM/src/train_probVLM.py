...
import clip
import ds 
from ds import load_mnist_data_loader, prepare_cub_dataloaders_extra, prepare_coco_dataloaders_extra #prepare_coco_dataloaders, prepare_flickr_dataloaders, prepare_cub_dataloaders, prepare_flo_dataloaders, 
...
#                xT = tokenizer(xT, padding='max_length', truncation=True, max_length=77, return_tensors='pt').to(device)
#                xfT = CLIP_Net(xT['input_ids'], attention_mask=xT['attention_mask'])
