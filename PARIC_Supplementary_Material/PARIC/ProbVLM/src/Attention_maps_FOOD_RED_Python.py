...
checkpoint_path = '../ProbVLM/ckpt/ProbVLM_FOOD_RedMeat_14.02_best.pth'

dataset = 'food-redmeat' 
filename = '../ProbVLM/Datasets/food-101/data_loaders_food_redmeat_17.02.pkl'
att_folder_mean = 'clip_rn50_attention_gradcam_food_redmeat_mean'
att_folder_median = 'clip_rn50_attention_gradcam_food_redmeat_median'
